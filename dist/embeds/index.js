...
var cancelMyRankEmbed = function cancelMyRankEmbed(userId) {
  var result = new _discord.EmbedBuilder().setColor(_settings["default"].bot.color).setTitle('MyRank').setDescription("<@".concat(userId, "> has canceled myRank")).setThumbnail(_settings["default"].bot.logo).setTimestamp().setFooter({
    text: "".concat(_settings["default"].bot.name, " v").concat(_package["default"].version),
    iconURL: _settings["default"].bot.logo
  });
  return result;
...
exports.cancelMyRankEmbed = cancelMyRankEmbed;
