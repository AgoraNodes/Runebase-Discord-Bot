...
module.exports = function (sequelize, DataTypes) {
  ...
  var UserGroupClassModel = sequelize.define('UserGroupClass', modelDefinition, modelOptions);

  UserGroupClassModel.associate = function (model) {
    ...
    UserGroupClassModel.belongsToMany(model.skill, {
      as: 'UserSkills',
