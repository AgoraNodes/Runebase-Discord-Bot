      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            _context3.next = 4;
            return _models["default"].featureSetting.count(options);

          case 4:
            res.locals.count = _context3.sent;
            _context3.next = 7;
            return _models["default"].featureSetting.findAll(options);
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 29:
            ...
            _context4.next = 35;
            return _models["default"].featureSetting.findOne(options);
