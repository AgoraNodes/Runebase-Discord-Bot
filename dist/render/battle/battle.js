...
var _loadEffect = require("./load/loadEffect");
    ...
    return _regenerator["default"].wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            allRoundBuffsInfoArray = _args.length > 4 && _args[4] !== undefined ? _args[4] : false;
            allRoundDebuffsInfoArray = _args.length > 5 && _args[5] !== undefined ? _args[5] : false;
            allRoundEffectsInfoArray = _args.length > 6 && _args[6] !== undefined ? _args[6] : false;
            stageZeroInfoArray = _args.length > 7 && _args[7] !== undefined ? _args[7] : false;
            stageOneInfoArray = _args.length > 8 && _args[8] !== undefined ? _args[8] : false;
            stageTwoInfoArray = _args.length > 9 && _args[9] !== undefined ? _args[9] : false;
            stageThreeInfoArray = _args.length > 10 && _args[10] !== undefined ? _args[10] : false;
            stageFourInfoArray = _args.length > 11 && _args[11] !== undefined ? _args[11] : false;
            stageFiveInfoArray = _args.length > 12 && _args[12] !== undefined ? _args[12] : false;
            stageSixInfoArray = _args.length > 13 && _args[13] !== undefined ? _args[13] : false;
            stageSevenInfoArray = _args.length > 14 && _args[14] !== undefined ? _args[14] : false;
              ...
              try {
                _loop = function _loop() {
                  var _step$value = (0, _slicedToArray2["default"])(_step.value, 2),
                      i = _step$value[0],
                      effectName = _step$value[1];

                  loadPromises.push(new Promise(function (resolve, reject) {
                    if (!effectImages[effectName]) {
                      (0, _loadEffect.loadEffect)(effectName).then(function (image) {
              ...
              try {
                _loop2 = function _loop2() {
                  var _step2$value = (0, _slicedToArray2["default"])(_step2.value, 2),
                      i = _step2$value[0],
                      buffName = _step2$value[1];

                  loadPromises.push(new Promise(function (resolve, reject) {
                    if (!buffImages[buffName]) {
                      (0, _loadBuff.loadBuff)(buffName).then(function (image) {
          ...
          case 45:
            ...
            _iterator5 = _createForOfIteratorHelper(BattleMonsters.entries());

            try {
              _loop53 = function _loop53() {
            ...
            if (stageZeroInfoArray && stageZeroInfoArray.length > 0) {
              _iterator6 = _createForOfIteratorHelper(stageZeroInfoArray.entries());

              try {
                _loop4 = function _loop4() {
                  var _step6$value = (0, _slicedToArray2["default"])(_step6.value, 2),
                      indexs = _step6$value[0],
                      stageZeroInfo = _step6$value[1];
                  ...
                  var _iterator7 = _createForOfIteratorHelper(stageZeroInfo.monstersToUpdate),
                      _step7;

                  try {
                    var _loop5 = function _loop5() {
                      var monsterToUpdate = _step7.value;
                      var monsterToUpdatePosition = enemyPosition.find(function (element) {
                        return element && element.id === monsterToUpdate.id;
                      });

                      var _iterator8 = _createForOfIteratorHelper(monsterToUpdate.effects.entries()),
                          _step8;
                      ...
                      try {
                        for (_iterator8.s(); !(_step8 = _iterator8.n()).done;) {
                          var _step8$value = (0, _slicedToArray2["default"])(_step8.value, 2),
                              ...
                              stageZeroInfoEffect = _step8$value[1];

                          (0, _drawBackground.drawBackground)(ctx, canvas, backgroundImage);

                          var _iterator9 = _createForOfIteratorHelper(BattleMonsters.entries()),
                              _step9;
                          ...
                          var _iterator10 = _createForOfIteratorHelper(stageZeroInfo.monstersToUpdate),
                              _step10;

                          try {
                            var _loop7 = function _loop7() {
                              var monsterToUpdate = _step10.value;
                              var monsterToUpdatePosition = enemyPosition.find(function (element) {
                                return element && element.id === monsterToUpdate.id;
                              });
            ...
            if (stageOneInfoArray && stageOneInfoArray.length > 0) {
              ...
              try {
                _loop10 = function _loop10() {
                  ...
                  var _iterator15 = _createForOfIteratorHelper(stageOneInfo.monstersToUpdate),
                      _step15;
            ...
            if (stageTwoInfoArray && stageTwoInfoArray.length > 0) {
              ...
              try {
                _loop17 = function _loop17() {
                  ...
                  var _iterator21 = _createForOfIteratorHelper(BattleMonsters.entries()),
                      _step21;
                  ...
                  var _iterator22 = _createForOfIteratorHelper(BattleMonsters.entries()),
                      _step22;
            ...
            if (stageThreeInfoArray && stageThreeInfoArray.length > 0) {
              _iterator26 = _createForOfIteratorHelper(stageThreeInfoArray.entries());

              try {
                _loop23 = function _loop23() {
                  var _step26$value = (0, _slicedToArray2["default"])(_step26.value, 2),
                      index = _step26$value[0],
                      stageThreeInfo = _step26$value[1];
                  ...
                  var _iterator28 = _createForOfIteratorHelper(BattleMonsters.entries()),
                      _step28;
                  ...
                  var _iterator29 = _createForOfIteratorHelper(stageThreeInfo.monstersToUpdate),
                      _step29;

                  try {
                    var _loop26 = function _loop26() {
                      var monsterToUpdate = _step29.value;
                      var monsterToUpdatePosition = enemyPosition.find(function (element) {
                        return element && element.id === monsterToUpdate.id;
                      });
                      ctx.fillText(monsterToUpdate.userDamage, monsterToUpdatePosition.x, monsterToUpdatePosition.y - 20, 50);
            ...
            if (stageFourInfoArray && stageFourInfoArray.length > 0) {
              _iterator35 = _createForOfIteratorHelper(stageFourInfoArray.entries());

              try {
                _loop32 = function _loop32() {
                  var _step35$value = (0, _slicedToArray2["default"])(_step35.value, 2),
                      index = _step35$value[0],
                      stageFourInfo = _step35$value[1];
                  ...
                  var _iterator37 = _createForOfIteratorHelper(BattleMonsters.entries()),
                      _step37;
            ...
            if (stageFiveInfoArray && stageFiveInfoArray.length > 0) {
              _iterator44 = _createForOfIteratorHelper(stageFiveInfoArray.entries());

              try {
                _loop41 = function _loop41() {
                  var _step44$value = (0, _slicedToArray2["default"])(_step44.value, 2),
                      index = _step44$value[0],
                      stageFiveInfo = _step44$value[1];
                  ...
                  var _iterator46 = _createForOfIteratorHelper(BattleMonsters.entries()),
                      _step46;
            ...
            if (stageSevenInfoArray && stageSevenInfoArray.length > 0) {
              _iterator50 = _createForOfIteratorHelper(stageSevenInfoArray.entries());

              try {
                for (_iterator50.s(); !(_step50 = _iterator50.n()).done;) {
                  _step50$value = (0, _slicedToArray2["default"])(_step50.value, 2), index = _step50$value[0], stageSevenInfo = _step50$value[1];
                  (0, _drawBackground.drawBackground)(ctx, canvas, backgroundImage);
                  (0, _drawUserBuffs.drawUserBuffs)(ctx, // Ctx drawing canvas
                  userState, // User Object
                  buffImages // image array of player images
                  ...
                  _iterator51 = _createForOfIteratorHelper(BattleMonsters.entries());
                  ...
                  (0, _drawBackground.drawBackground)(ctx, canvas, backgroundImage);
                  _iterator52 = _createForOfIteratorHelper(BattleMonsters.entries());

                  try {
                    _loop48 = function _loop48() {
                      var _step52$value = (0, _slicedToArray2["default"])(_step52.value, 2),
                          i = _step52$value[0],
                          battleMonster = _step52$value[1];
