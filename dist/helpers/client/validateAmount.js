...
var _invalidAmountMessage = require("./messageHandlers/invalidAmountMessage");

var _insufficientBalanceMessageHandler = require("./messageHandlers/insufficientBalanceMessageHandler");
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 21:
            activity = _context.sent;
            _context.next = 24;
            return (0, _minimumMessageHandler.handleMinimumMessage)(discordClient, message, setting, capType);
          ...
          case 49:
            activity = _context.sent;
            _context.next = 52;
            return (0, _insufficientBalanceMessageHandler.handleInsufficientBalanceMessage)(discordClient, message, capType);
